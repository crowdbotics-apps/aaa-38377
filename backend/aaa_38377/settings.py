"""
Django settings for aaa_38377 project.
...
WSGI_APPLICATION = 'aaa_38377.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aaa_38377 API",
    "DESCRIPTION": "API documentation for aaa_38377 App",
    "VERSION": "v1",
}
